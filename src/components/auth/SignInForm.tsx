...
import { login } from "@/app/redux/features/auth/authentication";
...
export default function SignInForm() {
  ...
  const handleLogin = (event: React.FormEvent) => {
    ...
    localStorage.setItem("auth-token", "Daniel@adey.com");
    dispatch(login()); // Dispatch login action to update Redux state
  };

  return (
    <div className="flex no-scrollbar overflow-y-auto flex-col flex-1 p-6 rounded-2xl sm:rounded-none sm:border-0 sm:p-8">
          ...
          <form onSubmit={handleLogin}>
            <div className="space-y-6">
              <div>
                ...
                <Input placeholder="info@adey.com"  />
              </div>
              <div>
